    ...
    <div id="indiv-container">
      <div id="indiv-left-container" className='floaty-container'>
        ...
        <div id="country-properties">
          <span><span id='prop-name'>Currency</span> : {Object.values(country.currencies)[0]['name']}</span>
          <span><span id='prop-name'>Languages</span> : {Object.values(country.languages).join(', ')}</span>
          <span><span id='prop-name'>Continent</span> : {country.region}</span>
          <span><span id='prop-name'>Demonym</span> : {country.demonyms['eng']['m']}</span>
          <span><span id='prop-name'>Capital</span> : {country.capital}</span>
        </div>
      </div>
      <div id="indiv-right-container" >
        <div id="indiv-right-top" className='floaty-container'>
        </div>
